...
#'
#' @param na_rm Si es `TRUE`, excluye los valores perdidos del indicador antes
#'   del calculo y omite los grupos que no contienen ningun registro valido para
#'   ese indicador. Si es `FALSE`, la funcion se detiene cuando el indicador
#'   contiene valores perdidos.
#'   If `TRUE`, missing indicator values are excluded before calculation and
#'   groups without valid records for that indicator are omitted. If `FALSE`,
#'   the function stops when the indicator contains missing values.
#'
...
#'
#' Cuando `na_rm = TRUE`, los valores perdidos del indicador no forman parte del
#' denominador. Ademas, los grupos que solo contienen valores perdidos o valores
#' fuera de `valid_values` para un indicador se omiten de la tabla de ese
#' indicador.
#'
...
#'
#' When `na_rm = TRUE`, missing indicator values are excluded from the
#' denominator. Groups containing only missing values or values outside
#' `valid_values` for an indicator are omitted from that indicator table.
#'
...
svySE_simple <- function(
  ...
  for (ind in indicators) {
    ...
    # -------------------------------------------------------------------------
    # Valores fuera de valid_values
    # Values outside valid_values
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # Filtrar registros validos del indicador
    # Filter valid indicator records
    # -------------------------------------------------------------------------
    ...
    # Los grupos se definen despues del filtrado del indicador.
    # Groups are defined after indicator filtering.
    groups_master <- sort(
